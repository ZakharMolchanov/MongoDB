          ...
          items:
            ...
            properties:
              ...
              created_at:
                ...
                format: date-time
    """
    items = Topic.query.order_by(Topic.topic_id.asc()).all()
    return jsonify([
        {
            "topic_id": t.topic_id,
            "title": t.title,
...
# POST /topics — создать тему (админ)
...
# PUT /topics/<topic_id> — обновить тему (админ)
...
# DELETE /topics/<topic_id> — удалить тему (админ)
